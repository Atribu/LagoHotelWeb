...
<InfoSection  isImageLeft={true} showLink={false} span="" header=" ENERJİ POLİTİKAMIZ" text="Tesis genelinde enerji verimliliğini artırmak için gerekli önlemleri almayı taahhüt ediyoruz. Bunun için enerji tüketimimizi sürekli olarak izleyecek ve analiz edecek teknolojileri kullanacağız.
...
Ekipmanların düzenli bakımını yaparak enerji verimliliğini koruyacak ve performanslarını optimize edeceğiz." text2="Yeni yatırımlarımızda enerji verimliliği standartlarını göz önünde bulunduracak ve çevresel etkileri minimize edecek altyapılar oluşturacağız.
...
" img={enerjiImg}/>
<InfoSection  isImageLeft={false} showLink={false} span="" header=" İNSAN HAKLARI POLİTİKAMIZ" text="Lago Hotel olarak ekonomik, çevresel ve sosyal sürdürülebilirliğe katkıda bulunma vizyonuyla çalışıyoruz.
...
Uluslararası Çalışma Örgütünün Temel İş İlkeleri ve Hakları Beyannamesinde ortaya konan ayrımcılık yapmama, çocuk işçi çalıştırmama, zorla işçi çalıştırmama, toplu sözleşme hakkı ve örgütlenme özgürlüğü ilkelerine ve Türkiye’nin insan hakları ve sosyal adalet konularında taraf olduğu Uluslararası sözleşmelerin gereklerini yerine getirme konusuna özen gösterir ve uygularız." text2="İşe alım, eğitim, kariyer, ücret yönetimi gibi süreçlerde ve iş ortamında cinsiyet, etnik köken, din, ırk, milliyet, yaş, fiziksel kapasite, hamilelik, medeni hal, cinsel yönelim, sendika üyeliği, siyasal görüş ve benzeri konulara bağlı olarak ayrım yapmadan eşit bir tutum sergiler, ayrımcılığa müsamaha göstermeyiz.
...
İş sağlığı ve güvenliği yaklaşımımızın temelini “sıfır kaza” hedefimiz oluşturur. İş ortaklarımıza ve çalışanlarımıza güvenli bir çalışma ortamı sunmaya önem veririz. " img={peopleImg}/>

<InfoSection  isImageLeft={true} showLink={false} span="" header="İŞ SAĞLIĞI VE GÜVENLİĞİ POLİTİKAMIZ" text="Lago Hotel tüm çalışanlar, taşeronlar ve misafirler dahil olmak üzere işyerinde bulunan herkesin sağlık, güvenlik ve refahını sağlamayı amaçlar.
...
Tüm çalışanların, yüklenicilerin ve ziyaretçilerin iş güvenliğini iyileştirmek için alınacak önlemlerin geliştirilmesi ve desteklenmesi kapsamında etkin katılımını teşvik ederek bir iş güvenliği kültürü oluşturmak." text2="Yürürlükteki tüm İSG ile ilgili mevzuat, düzenlemeler ve standartlarıyla uyumlu olmak Organizasyon kapsamındaki risklerle ilgili ve bunlara uygun risk ve tehlike yönetim sistemleri uygulamak.
...
Bu standartlar işletmede sürekli iyileşmenin sağlanabilmesini kolaylaştırmak amacıyla bütünlük ve etkinliğin korunduğundan emin olmak için düzenli olarak izlenecektir." img={workImg}/>

<InfoSection  isImageLeft={false} showLink={false} span="" header="ÇOCUK KORUMA POLİTİKAMIZ" text="Lago Hotel çocukların refahını desteklemesi taahhüt eder, çocuk haklarına saygı duyma ve çocukları her türlü sömürü türlerine karşı korumak için gerekli tedbirleri alırız.
...
Aktiviteler de bulunuruz." text2="Personelimize çocuk koruma ile ilgili eğitimler düzenleriz.
...
Dezavantajlı olsun ya da olmasın tüm vatandaşların çalışma hakkına sahip olması gerektiği inancında olduğumuzdan tesisimizde dezavantajlı personellerimiz de istihdam edilmektedir. Bu çerçevede dezavantajlı farkındalık politikamız herkes için eşit şartlarda tatilin önündeki engelin kaldırılmasıdır." img={people2Img}/>

<InfoSection  isImageLeft={false} showLink={false} span="" header="SAVUNMASIZ GRUPLAR İSTİSMAR VE TACİZ POLİTİKAMIZ" text="Lago Hotel olarak, savunmasız grupların haklarını koruma ve istismar veya taciz olaylarının önlenmesine yönelik güçlü bir taahhütte bulunmaktayız. Çalışanlarımızın, misafirlerimizin ve tüm paydaşlarımızın güvende olmasını sağlamak için gereken adımları atmayı hedefliyoruz.
...
<InfoSection  isImageLeft={true} showLink={false} span="" header=" TOPLAM KALİTE YÖNETİM POLİTİKAMIZ" text="Misafirlere, devletimizin öngördüğü değerlere, tedarikçilik yapan çözüm ortaklarımıza, çalışanlarımıza, işverenimize karşı hakkaniyet ve güzel beşeriyet dışında hiçbir öznel tasarrufumuz olmayacaktır.
...
Herkese eşit şartlarda hizmet anlayışı ve konusunda eğitimini almış personelimiz ile dezavantajlı misafirlerimize sadece odalarında değil, tüm hizmet alanlarımızda kendilerine evlerindeki konforu sağlamak için tüm alt ile hizmet vermekteyiz." img={qualityImg}/>


<InfoSection  isImageLeft={false} showLink={false} span="" header=" TOPLUMA UYUM POLİTİKAMIZ" text="Lago Hotel olarak, içinde bulunduğumuz yerel topluluğu desteklemeye ve onlarla birlikte çalışmaya kendisini adamıştır. İşimizi, destinasyonun kültürünü ve mirasını ve yerel ekonomiyi korumaya ve tanıtmaya yardımcı olacak şekilde yürütmeyi taahhüt ediyoruz.
