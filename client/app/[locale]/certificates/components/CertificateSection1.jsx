...
const CertificateSection1 = () => {
  return (
    <div className='flex w-screen items-center justify-center'>
        <div className='flex flex-col-reverse lg:flex-row w-[87.79%] md:w-[91.4%] lg:w-[76.8%] items-center justify-center gap-[15px] md:gap-[25px] lg:gap-[50px]'>
            <Image
            src={img}
            alt='certificate'
            width={img.width}
            height={img.height}
            className='w-[100%] lg:w-auto max-h-[664px] object-cover shadow-lg transition-shadow duration-300 ease-in-out hover:shadow-xl'
            />
