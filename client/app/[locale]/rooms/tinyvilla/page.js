...
const page = () => {
  ...
  return (
    <div className=' overflow-hidden flex flex-col items-center justify-center gap-[60px] md:gap-[80px] lg:gap-[100px] bg-[#fbfbfb]'>
     ...
     <SubRoomBanner img={img1} span="exclusive stay with an INDEPENDENT pool" header="VILLA" texts={subroomBannerText}/>
     <SubroomCarousel images={carouselImages}/>
     </div>
      <RoomFeatures span=" FUN FOR ALL ages" header="Villa Room" text="   It is located in our main building with a volume of 50-55 m2 with
