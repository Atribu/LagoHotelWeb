  ...
  return (
    <div className='flex w-screen h-[45vh] min-h-[460px] items-center justify-center bg-center bg-cover  relative' style={{ backgroundImage: `url(${img.src})` }}>
      ...
      <div className='flex flex-col ml-0 md:ml-8 lg:ml-0 w-[87.79%] md:w-[91.4%] lg::w-[48.19%] items-center text-center md:text-start md:items-start justify-center gap-[20px] lg:gap-[30px] font-jost text-white z-10'>
        ...
        <h3 className='text-[28px] md:text-[32px] lg:text-[48px] font-marcellus font-normal leading-[120%] lg:leading-[63.6094px] lg:capsizedText2'>Magna Main Restaurant</h3>
        <p className='text-[14px] lg:text-[16px] font-normal leading-[18px] lg:leading-[24px] list-disc capsizedText4 w-[50%]'>For breakfast, lunch, and dinner, we have prepared an endless open buffet where you may immerse in both authentic Turkish cuisine sensations and seasonal delicacies.</p>
