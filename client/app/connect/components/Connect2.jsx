...
const Connect2 = () => {
  return (
    <div className="relative w-full flex flex-col items-center ">
      ...
      {/* Form overlay */}
      <div className="absolute min-w-[350px] w-[78vw] max-w-[480px] min-h-[30vh] md:min-h-[40vh] lg:w-[480px] lg:h-[684px] top-1/2  -translate-y-1/2 lg:-translate-y-0 lg:translate-x-0  lg:top-[4%] right-1/2 translate-x-1/2 lg:right-[20%] bg-white shadow-lg p-[18px] lg:p-[30px] z-10 text-center ">
