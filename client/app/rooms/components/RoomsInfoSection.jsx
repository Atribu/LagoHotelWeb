...
const RoomsInfoSection = () => {
  return (
      <div className="flex flex-col lg:flex-col w-screen h-auto justify-center items-center bg-[#fbfbfb] max-w-[1444px] px-4 lg:px-0">
      ...
      <div className="flex flex-col w-[76.8%] gap-[14px] items-center justify-center text-center font-jost leading-normal font-normal ">
        ...
        <h2 className="text-black text-[36px] font-marcellus lg:w-[75%]">
          Explore our refined accommodation options and find the perfect space
          for your stay.
        </h2>
        <p className="text-black md:text-center text-[16px] lg:w-[65%]">
        ...
        <div className="flex flex-row w-full lg:w-[70%] justify-between gap-[70px] lg:gap-[1px] items-center mt-[24px]">
