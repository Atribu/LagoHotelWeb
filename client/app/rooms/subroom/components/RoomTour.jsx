...
const RoomTour = ({span,header,text}) => {
  return (
    <div className='flex w-screen h-auto items-center justify-center max-w-[1440px]'>
      <div className='flex flex-col w-[76.8%] items-center justify-center gap-[50px] max-w-[1106px] font-jost'>
       ...
       <p className='text-[16px] leading-[24px] font-normal w-[70%] capsizedText4'>{text}</p>
       </div>
