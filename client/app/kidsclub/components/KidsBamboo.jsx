  ...
  return (
    <div className='flex flex-col w-screen items-center justify-center h-auto my-[100px] gap-[50px]' >
      ...
      <div className='flex gap-[28px] w-[76.8%] justify-between items-center text-white font-jost '>
        <div className='flex flex-col w-[33%] items-center justify-end pb-6 h-[58vh] bg-center bg-cover relative group '  style={{ backgroundImage: `url(${miniclub.src})` }}>
          ...
          <span className='text-[12px] font-normal uppercase tracking-[0.48px] leading-[14px]  transition-opacity duration-500 ease-in-out opacity-100 group-hover:opacity-0'>4-7 yaş grubu</span>
          <h4 className='text-[30px] leading-[57.6px] font-marcellus font-normal capitalize  transition-opacity duration-500 ease-in-out opacity-100 group-hover:opacity-0'>Mini Club</h4>
          </div>
          <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100"></div>
              <div className="absolute inset-0  text-white flex flex-col
               justify-start items-center text-start font-montserrat gap-[20px] top-1 transform translate-y-1/2 transition-transform opacity-0 -group-hover:translate-y-1 group-hover:opacity-100 duration-700 ease-in-out ">
                <div className="flex flex-col w-5/6 gap-[10px] itesm-start justify-center">
                <span className='text-[12px] font-normal uppercase tracking-[0.48px] leading-[14px]'>4-7 yaş grubu</span>
                <h4 className='text-[30px] leading-[57.6px] font-marcellus font-normal capitalize  '>Mini Club</h4>
                <div className="flex w-full h-[1px] bg-grayLight"></div>
                <p className='text-[11px]'>Bamboo Kids Club, age-appropriate activities, professional caregivers, and a secure environment, we provide the perfect setting for your child to learn, play, and grow.</p>
                
                </div>
              </div>
        </div>

        <div className='flex flex-col w-[33%] items-center justify-end pb-6 h-[58vh] bg-center bg-cover relative group '  style={{ backgroundImage: `url(${juniorclub.src})` }}>
          <div className='absolute bg-black/10 inset-0 z-1'></div>
        ...
        <div className='flex flex-col w-[33%] items-center justify-end pb-6 h-[58vh] bg-center bg-cover relative group '  style={{ backgroundImage: `url(${teenageclub.src})` }}>
          <div className='absolute bg-black/10 inset-0 z-1'></div>
          <div className='flex flex-col w-5/6 items-start justify-end z-10'>
          <span className='text-[12px] font-normal uppercase tracking-[0.48px] leading-[14px]  transition-opacity duration-500 ease-in-out opacity-100 group-hover:opacity-0'>4-7 yaş grubu</span>
          <h4 className='text-[30px] leading-[57.6px] font-marcellus font-normal capitalize  transition-opacity duration-500 ease-in-out opacity-100 group-hover:opacity-0'>Mini Club</h4>
      ...
      <span className='text-[14px] text-lagoGray font-jost leading-[26px] font-normal text-center'> *0-3,99 age groups can join the mini club under the supervision of their parents</span>
    </div>
  )
}
