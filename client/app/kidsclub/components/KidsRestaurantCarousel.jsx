...
const KidsRestaurantCarousel = () => {
  ...
  return (
    <div className='flex flex-row-reverse w-screen justify-between items-center h-auto  '>
      <div className='flex w-[48%] font-jost items-start justify-start relative'>
       ...
       <span className='text-[12px] font-medium uppercase tracking-[0.48px] leading-[14px]'>bamboo kıds club</span>
        <h2 className='text-[48px] leading-[57.6px] font-marcellus font-normal capsizedText2'>Magna Kids Restoran</h2>
        ...
        <ul className="text-[14px] font-normal leading-[21px] list-disc capsizedText4 pl-5 marker:text-xs marker:text-lagoBlack w-[92%]">
           <li> Breakfast: 07:00 - 10:30 </li>
          <li>  Lunch: 12:30 - 14:00</li>
           <li> Dinner: 18:30 - 21:30 </li>
          </ul>
       </div>
       <PlateSvg className="absolute top-[65%] right-[20%]" width={221} height={212}/>
      </div>

      <div className="flex flex-col w-[50%] justify-start items-start h-[40vh] overflow-y-auto min-h-[434px]">
           {/* carousel */}
           <div className="flex overflow-hidden relative w-full  h-full flex-col justify-start items-start" ref={emblaRef}>
        <div className="flex grid-flow-col h-full w-[50vw] min-w-[533px]">
          {images.map((image, index) => (
           <div className="flex-[0_0_100%] md:flex-[0_0_69%] lg:flex-[0_0_74%] xl:flex-[0_0_auto] min-w-0 mr-[1.8%]" key={index}>
              <Image
                src={image.src}
                layout="cover"
                width={image.width}
