...
<div className="overflow-hidden w-full" ref={emblaRef}>
      <div className="flex ">
        {cuisines.map((room) => (
          <div
            key={room.id}
            className="flex-[0_0_100%] md:flex-[0_0_50%] lg:flex-[0_0_32%] xl:flex-[0_0_31.5%] min-w-0 mr-[1.8%]"
          >
            <div className="flex flex-col w-full items-start text-start justify-center gap-[25px] font-jost text-black ">
              ...
              <p className="text-[14px] leading-[21px] font-normal capsizedText4 line-clamp-3">
               {room.text}
              </p>
