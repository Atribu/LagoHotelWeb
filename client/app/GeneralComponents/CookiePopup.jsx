...
const CookiePopup = () => {
  ...
  const contents = [
    <div className="flex flex-col h-full w-[99%] text-start text-[#FBFBFB] overflow-y-auto z-[9999] font-jost">
    ...
    <div className="flex flex-col h-full w-[96%] text-start items-start justify-start">
      <div className="flex w-full py-[10] items-center justify-start gap-[14px] border-b border-[#a6a6a6]">
        ...
        <h4 className="text-[16px] font-medium leading-[26.667px] w-[203px] md:w-[71vw] lg:w-[46vw]">
          Strictly Necessary
        </h4>
        <div
    ...
    isVisible && (
      <div className="fixed flex z-[9999] bottom-0 bg-[rgba(29,29,27,0.85)] backdrop-blur-[10px] right-0 left-0 w-screen items-center justify-center">
        <div className="flex flex-col md:flex-row w-[94%] md:w-[99%] lg:w-[94%] py-[25px] gap-[30px] font-montserrat text-center items-center justify-center text-[#FBFBFB] font-jost">
          ...
          <div className="md:flex hidden text-[14px] leading-[130%] text-[#FBFBFB] font-normal font-jost text-center md:min-w-[38%] ml-[2%] ">
            <p>
              <span className="font-medium underline">We Use Cookies:</span> We
          ...
          <div className="grid grid-cols-2 lg:flex lg:flex-row md:gap-[20px] xl:gap-[30px] w-full items-center justify-center gap-[13px] mr-[2%]">
            ...
            {isModalOpen && (
              <div
                className="flex fixed bottom-0 left-0 items-center justify-center w-screen z-[9999] "
                onClick={handleModalToggle}
              >
                <div
                  className="flex flex-col w-full  h-screen bg-[rgba(29,29,27)] backdrop-blur-[10px] items-center justify-end relative z-[9999]"
                  onClick={(e) => e.stopPropagation()}
                >
                  <div className="flex w-[90%] lg:w-[54%] items-center h-full md:h-[90%] justify-between">
                    <Image
                      src={logosvg}
                      alt="Logo"
                  ...
                  <div className="flex flex-col gap-4 items-center justify-center py-2 md:h-screen md:w-screen text-[#FBFBFB] max-w-screen">
                    <div className="flex flex-col w-[97%] lg:w-[60%] justify-center items-center gap-[14.5px]">
                      <div className="grid grid-cols-2 md:flex lg:flex-row  w-[98%] md:w-[90%] lg:w-[92%] text-start text-[16px] font-bold gap-[10px]">
                        {[
                          ...
                          <button
                            ...
                            className={
                              selectedContent === index
                                ? "text-white text-[16px] font-jost leading-normal font-medium w-auto cursor-pointer p-[10px] border-none whitespace-nowrap underline border items-start justify-start text-start h-[48px] underline]"
                                : " text-[16px] font-jost leading-normal font-medium text-[#A6A6A6] whitespace-nowrap cursor-pointer p-[10px] border-none items-start justify-start text-start h-[48px]"
                            }
                          >
                            {buttonLabel}
                          </button>
                      ...
                      <div className="flex flex-col w-[90%] h-[514px] md:h-[55vh] overflow-y-auto items-start justify-start text-start">
                        {/* Dinamik Başlık */}
                        <button className="text-[16px] font-medium text-[#FBFBFB] font-jost leading-normal py-1 border-b border-[#FBFBFB] mb-[15px]">
                          {
                            [
                              "Cookie Clarification Text",
                              "What Are Cookies?",
                      ...
                      <div className="flex items-center justify-center w-[100%] gap-[13px] lg:gap-[10%] mt-[40px] mb-[20px]">
