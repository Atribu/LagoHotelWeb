...
const ModalPortal = ({ children, onClose }) => {
  return ReactDOM.createPortal(
    <div
      ...
      onClick={onClose}
    >
      <div onClick={(e) => e.stopPropagation()} className="w-full h-screen lg:w-[715px] lg:h-[651px] bg-[rgba(29,29,27,0.60)] backdrop-blur-[10px]">
        {children}
      </div>
    </div>,
    document.body
...
const CookiePopup = () => {
  ...
  const contents = [
    ...
    <div className="flex flex-col h-full w-[96%] text-start font-jost items-start justify-start  gap-[7.5px] overflow-y-scroll thin-scrollbar max-h-[500px]">
      ...
      {/* 3.toggle */}
      <div className="flex w-full p-[10px] items-center justify-start gap-[14px] border-b border-[#a6a6a6]">
        <div   onClick={() => setIsDropdown3Open(!isDropdown3Open)} className="flex items-center justify-start gap-[14px] w-[82%] sm:w-[90%] md:w-[76vw] lg:w-[530px]">
        <div
      ...
      {/* 4.toggle */}
      <div className="flex w-full p-[10px] items-center justify-start gap-[14px] border-b border-[#a6a6a6]">
       <div  onClick={() => setIsDropdown4Open(!isDropdown4Open)} className="flex items-center justify-start gap-[14px] w-[82%] sm:w-[90%] md:w-[76vw] lg:w-[530px]">
       <div
          className="flex items-center cursor-pointer transition-transform duration-300"
    ...
    <div className="flex flex-col h-full w-[98%] sm:w-[95%] lg:w-[99%] text-start text-[#FBFBFB] overflow-y-scroll overflow-x-hidden z-[9999] font-jost thin-scrollbar">
      <p className="text-[13px] font-normal leading-[19.5px] pr-[3.5%] lg:pr-[7.5%]">
        ...
        kullanılmaktadır. Web sitemizde kullanılan zorunlu çerezlerin sağlayıcıları ve kullanım amaçları aşağıda belirtilmiştir:
        
        2.Pazarlama Çerezleri Pazarlama amaçlı çerezler ile
        ...
        3. Analitik Çerezler 
        İnternet sitelerinde, kullanıcı davranışlarını analiz etmek
        ...
        Zorunlu Çerezler: Web sitesinin kullanımı ve işlevselliği için elzem olan
        ...
        çerezlerin sağlayıcıları ve kullanım amaçları aşağıda belirtilmiştir: 
        
        <table class="w-[90%] border-collapse my-[15px] text-[12px] overflow-x-scroll">
    <thead>
      <tr className="color-[#233038] border-[#fff]">
        <th className="border p-[2px] text-left leading-normal">Çerez Servis Sağlayıcısı</th>
        <th className="border p-[2px] text-left leading-normal">Çerez İsmi</th>
        <th className="border p-[2px] text-left leading-normal">Çerez Açıklaması</th>
        <th className="border p-[2px] text-left leading-normal">Çerez Tipi</th>
        <th className="border p-[2px] text-left leading-normal">Çerez Süresi</th>
        <th className="border p-[2px] text-left leading-normal">Çerez Kategorisi</th>
      </tr>
    </thead>
    <tbody>
      <tr className="color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">_gcl_au</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Google Analytics işlevselliğini desteklemek amacıyla kullanılmaktadır.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">3 Ay</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>
      <tr className=" color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">www.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">wp-wpml_current_language</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Geçerli dili saklar. Bu çerez, AJAX işlemleri için Dil filtreleme özelliğini kullanan sitelerde varsayılan olarak etkindir.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Oturum</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>
      <tr className=" color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.google.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">AEC</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">İnternette gezinme oturumundaki isteklerin başka siteler değil, kullanıcı tarafından yapılmasını sağlar. Bu çerezler, kötü amaçlı sitelerin kullanıcının bilgisi olmadan kullanıcı adına hareket etmesini önler.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">6 ay</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>

      <tr className=" color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.google.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">NID</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Kullanıcının son aramaları ve önceki etkileşimlerine dayalı olarak Google'ın kişiselleştirilmiş reklamlar sunması için kullanılır.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">6 ay</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>
      ...
      <tr className="color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">_ga</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Google Analytics işlevselliğini desteklemek amacıyla kullanılmaktadır.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">2 yıl</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>

      <tr className=" color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">_ga_*</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Google Analytics bu çerezi sayfa görüntülemelerini saklamak ve saymak için ayarlar.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">1 yıl</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>

      <tr className=" color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.doubleclick.net</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">test_cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Bu çerez, web sitesi ziyaretçisinin tarayıcısının çerezleri destekleyip desteklemediğini belirlemek için DoubleClick (Google'a aittir) tarafından ayarlanır.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">15 Dakika</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>

      <tr className=" color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">_ga_KXPQT1BLP9</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Google Analytics işlevselliğini desteklemek amacıyla kullanılmaktadır.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">24 Ay</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
      </tr>

      <tr className=" color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">_ga_R5Y8HBEP1H</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Google Analytics işlevselliğini desteklemek amacıyla kullanılmaktadır.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">24 Ay</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Zorunlu</th>
        ...
        2.Pazarlama Çerezleri :  Pazarlama amaçlı çerezler ile internet ortamında
    ...
    <tbody>
      <tr className="color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">_fbp</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Facebook, bu çerezi, web sitesini ziyaret ettikten sonra Facebook’ta veya Facebook reklamcılığı tarafından desteklenen bir dijital platformda reklam görüntülemek üzere ayarlar.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">3 Ay</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Pazarlama</th>
      </tr>
    </tbody>
  </table>
        3.Analitik Çerezler İnternet sitelerinde,
    ...
    <tbody>
      <tr className="color-[#233038] font-medium">
        <th className="border p-[2px] text-left leading-normal  font-medium">.lagohotel.com</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">_gid</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Ziyaretçinin web sitesini nasıl kullandığına ilişkin istatistiksel veriler oluşturmak için kullanılan benzersiz bir kimlik kaydeder.</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Persistent Cookie</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">1 Gün</th>
        <th className="border p-[2px] text-left leading-normal  font-medium">Analitik</th>
      </tr>
    </tbody>
  </table>
        
        4.Fonksiyonel Çerezler
         İnternet sitemizdeki sistemlerin düzgün işleyişine yardımcı
        olmak adına kullanılan çerezlerdir. 
        <ul className="text-[12px] font-normal leading-[21px] my-2 list-disc capsizedText4 pl-5 marker:text-xs marker:text-white ">Web sitemizden yapılan üçüncü taraf
        yönlendirmeler aşağıda belirtilmiştir:
          <li> Lago Hotel rezarvasyon linkimiz” 
          lagohotel.hotelagent.com</li>
          <li>Lago Hotel için TripAdvisor yorum sayfası  https://www.tripadvisor.com.tr/Hotel_Review-g1192102-d545626-Reviews-Lago_Hotel-Sorgun_Manavgat_Turkish_Mediterranean_Coast.html</li>
          <li>Lago Hotel için Holidaycheck yorum sayfası  https://www.holidaycheck.de/hi/lago-hotel/2e44d958-7e5e-4423-92b2-84bb298826b0</li>
          <li>Lago Hotel için TopHotels yorum sayfası  https://tophotels.ru/hotel/al24898</li>
          <li>Lago Hotel Facebook sayfası https://www.facebook.com/lagohotels</li>
          <li>Lago Hotel İnstagram sayfası  https://www.instagram.com/lagohotels/</li>
          <li>Lago Hotel Youtube sayfası https://www.youtube.com/channel/UCjbL19l36uYQEdy2EEw1nLQ </li>
        </ul>
         Diğer internet sitelerine bağlantılar <br/>
          İnternet sitemizdeki içerikler üçüncü
        ...
        iyileştirilmektedir.<br/> Sitemizi ziyaretinizle birlikte birtakım kişisel
        ...
        bilgi sahibi olabilirsiniz.<br/> Çerezler aracılığıyla elde edilen kişisel
        verilerinize;<br/>
         Kişisel verilerinizin işlenip işlenmediğini öğrenme, (b)
        ...
        etme. <br/>
        Kişisel verilerinize ilişkin işbu haklarınızı VERİ SORUMLUSUNA
        ...
        kullanmak suretiyle tarafımıza iletebilirsiniz. <br/>
        Çerezlerin Kullanımını Nasıl Engellersiniz? <br/>Çerezlerin kullanılması, web 
        sitesinin daha iyi
        ...
        <ul className="text-[12px] mt-2 font-normal leading-normal list-disc capsizedText4 pl-5 marker:text-xs marker:text-white">
          <li> Microsoft Edge
            <ol className=" list-decimal list-inside">
              <li>Microsoft Edge tarayıcınızın sağ üst köşesinde bulunan üç nokta simgesine tıklayın ve Ayarlar’a gidin.</li>
              <li> Temizlenecek Öğeleri Seç seçeneğine tıklayın ve temizlemek istediğiniz bölümleri seçin.</li>
              <li>Seçiminizi yaparak temizleme işlemine başlayabilirsiniz.</li>
            </ol>
          </li>
          <li className="my-2">Google Chrome
            <ol className=" list-decimal list-inside">
              ...
              <li>“Tüm çerezler ve site verileri” altında istediğiniz web sitesini bulun.</li>
              <li>Sitenin yanındaki Kaldır simgesine tıklayın.</li>
            </ol>
          </li>
          <li className="my-2">Mozilla Firefox
            <ol className=" list-decimal list-inside">
              <li>Firefox Menü düğmesine tıklayın ve Seçenekler’i seçin.</li>
              <li>Gizlilik ve Güvenlik bölümünü seçin, ardından Geçmiş bölümüne gidin.</li>
              <li> “Firefox, geçmiş için özel ayarları kullan” seçeneğini işaretleyin.</li>
              <li>  Çerezleri göster… düğmesine tıklayın.</li>
              <li> Arama: alanına, silmek istediğiniz web sitesinin adını yazın.</li>
              <li> Silmek istediğiniz çerezleri seçin ve Seçilenleri Sil’e tıklayın.</li>
              <li>   Çerezler penceresini kapatın ve ardından about:preferences sayfasını kapatın.</li>
            </ol>
          </li>
          <li className="my-2">Safari
            <ol className=" list-decimal list-inside">
          ...
          <li className="my-2">Internet Explorer
            <ol className=" list-decimal list-inside">
              <li>Bilgisayarınızın masaüstünde Internet Explorer simgesine tıklayın.</li>
              <li> Araçlar düğmesine ve ardından İnternet Seçenekleri’ne tıklayın.</li>
              <li> Gizlilik sekmesine tıklayın, sonra tüm tanımlama bilgilerini engellemek için Ayarlar altında bulunan kaydırıcıyı yukarıya çekin ve Tamam düğmesine tıklayın.</li>
            </ol>
          </li>
        </ul>
  ...
  return (
    isVisible && (
      <div className="fixed flex z-[9999] bottom-0 bg-[rgba(29,29,27,0.85)] backdrop-blur-[10px] right-0 left-0 w-screen items-center justify-center">
        <div className="flex flex-col md:flex-row w-[94%] md:w-[99%] lg:w-[94%] xl:w-[80%] xl:max-w-[1440px] py-[25px] gap-[20px] font-montserrat text-center items-center justify-center text-[#FBFBFB] font-jost">
          ...
          <div className="grid grid-cols-2 lg:flex lg:flex-row md:gap-[20px] xl:gap-[30px] w-full items-center justify-center gap-[13px] mr-[2%]  ">
            ...
            {isModalOpen && (
                 ...
                 <ModalPortal onClose={handleModalToggle}>
                  <div className="flex flex-col items-center justify-center gap-[30px] lg:gap-[39px]">
                  ...
                  <div className="flex flex-col gap-4 items-center justify-center pb-2 lg:pb-0 md:h-[100%] text-[#FBFBFB] max-w-screen lg:mt-[36px] h-auto">
                    <div className="flex flex-col w-[80%] sm:w-[90%] lg:w-[100%] justify-center items-center lg:items-start lg:justify-start gap-[14.5px] lg:gap-[15px] ">
      ...
      {orderedButtons.map((button) => (
        ...
        >
          {button.label}
                      ...
                      <div className="flex flex-col w-[88%] h-[58vh] md:h-[55vh] lg:h-[376px] lg:w-[85%] lg:ml-[7%] mt-[2vw] lg:mt-0 items-start justify-start text-start ">
                        {/* Dinamik Başlık */}
                        {/* İçerik */}
                      ...
                      <div className="absolute bottom-[4%] sm:bottom-[8%] flex lg:hidden items-center justify-center w-[100%] gap-[13px] font-jost">
                        <button className="text-[14px] uppercase font-medium leading-normal text-[#FBFBFB] px-[20px] py-[10px] border border-[#FBFBFB] whitespace-nowrap max-w-[170px]">
                          Deny All Cookies
                        </button>
                        <button className="text-[14px] uppercase font-medium leading-normal text-[#FBFBFB] px-[20px] py-[10px] border border-[#FBFBFB] whitespace-nowrap max-w-[184px]">
